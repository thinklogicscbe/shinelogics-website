...
const services = [
  {
    ...
    descriptions: [
      {
        title: "Product Development",
        description: "From ideation and prototyping to deployment and ongoing support...",
        image: product,
      },
      {
        title: "Technology Innovation",
        description: "We harness the power of the latest technologies...",
        image: tech,
      },
      {
        title: "Scalability & Growth",
...
const Service = () => {
  ...
  return (
    <SectionContainer>
      ...
      <AdditionalContainers>
        {Array.from({ length: 4 }).map((_, index) => (
          <ContainerBox key={index} $isLeft={index % 2 === 0} $delay={index * 0.3}>
            <ContainerTitle>ERP Solution</ContainerTitle>
            <ContainerText>{serviceDescription}</ContainerText>
          </ContainerBox>
        ))}
