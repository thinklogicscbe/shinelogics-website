    ...
    <Destinationcontiner>
      ...
      <TopSection>
        ...
        <ContentWrapper>
          ...
          <Destinationcontent>
            We are seeking a creative and detail-oriented UI/UX Designer to join
            our team. In this role, you will be responsible for designing
            intuitive and engaging user interfaces for our services. You will
            collaborate closely with our product managers, developers, and other
            stakeholders to create designs that not only meet user needs but
            also align with our business goals.
          </Destinationcontent>
        </ContentWrapper>
      </TopSection>{" "}
      {/* top section end */}
      ...
      <BottomSection>
        ...
        <Leftsidecontent>
          ...
          <SectionTitle style={{ marginLeft: "6%" }}>
            Job Description:
          </SectionTitle>
          <List style={{ marginLeft: "12%" }}>
            <li>
              Create wireframes, prototypes, and high-fidelity mock-ups for web
              and mobile applications.
            </li>
            <li>
              Translate design concepts into responsive, clean HTML and CSS
              code.
            </li>
            <li>
        ...
        <Rightsidecontent>
          <Jobsummery>
            ...
            <Qualification>
              <h4>
                <img
                  src="/img/job icon/qualification.png"
                  width="20"
                  height="20"
                  alt="Location Icon"
                />{" "}
