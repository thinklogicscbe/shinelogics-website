  const routes = [
    ...
    { path: "/ProductCompo/data-engineering", exact: true, component: "DataEngineering" },
    ...
    { path: "/ProductCompo/SoftwareDevelopment", exact: true, component: "SoftwareDevelopment" },
    { path: "/ProductCompo/ApplicationTesting", exact: true, component: "ApplicationTesting" },
    { path: "/ProductCompo/AIML", exact: true, component: "AIML" },
    { path: "/ProductCompo/IoT-EmbeddedSystems", exact: true, component: "IoT-EmbeddedSystems" },
    { path: "/ProductCompo/DataEngineering-Analytics", exact: true, component: "DataEngineering-Analytics" },
